      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <img src={logo} alt="Recipe Generator" className="h-10 w-auto mb-4" />
            <p className="text-gray-400 text-sm mt-2">
              Revolutionizing cooking with AI-powered recipes tailored to your preferences.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/dessert" className="text-gray-400 hover:text-white transition">
                  Create Dessert
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="#2" className="text-gray-400 hover:text-white transition">
                  Help Center
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="mailto:support@recipegenerator.com" className="text-gray-400 hover:text-white transition">
              ...
              <li className="flex space-x-4 mt-4">
                ...
                <a href="https://x.com/?lang=en" className="text-gray-400 hover:text-white transition">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
